...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './program.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRAM actions', async () => {
      const expectedActions = [
        {
