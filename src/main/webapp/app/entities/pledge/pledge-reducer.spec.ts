...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pledge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLEDGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLEDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLEDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLEDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLEDGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLEDGE actions', async () => {
      const expectedActions = [
        {
