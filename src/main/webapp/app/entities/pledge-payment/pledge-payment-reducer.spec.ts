...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLEDGEPAYMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLEDGEPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLEDGEPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLEDGEPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLEDGEPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLEDGEPAYMENT actions', async () => {
      const expectedActions = [
        {
