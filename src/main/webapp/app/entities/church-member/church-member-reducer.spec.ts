...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHURCHMEMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHURCHMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHURCHMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHURCHMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHURCHMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHURCHMEMBER actions', async () => {
      const expectedActions = [
        {
